          ...
          children: [
            ...
            TableRow(children: [
              TableCell(
                child: Padding(
                    padding: inSetCell,
                    child: _buildResultRow('Pr(~A)+Pr(A) = ', prAPlusNotA)),
              ),
              TableCell(
                child: Padding(
                    padding: inSetCell,
                    child: _buildResultRow('Pr(~B)+Pr(B) = ', prBPlusNotB)),
              )
            ]),
            TableRow(children: [
              TableCell(
              ...
              TableCell(
                child: Padding(
                    ...
                    child: _buildResultRow(
                        'Pr(A)Pr(B) = ', (prA.$1 * prB.$1, prA.$2 * prB.$2))),
              ),
            ]),
            TableRow(children: [
              TableCell(
            ...
            TableRow(children: [
              ...
              TableCell(
                child: Padding(
                    padding: inSetCell,
                    child: _buildResultRow(
                        'Pr(B)Pr(C) = ', (prB.$1 * prC.$1, prB.$2 * prC.$2))),
              ),
            ]),
            TableRow(children: [
              TableCell(
            ...
            TableRow(children: [
              TableCell(
                  child: Padding(
                      padding: inSetCell,
                      child: _buildResultRow('Pr(C|~A) = ', prCgivenNotA))),
              TableCell(
                  child: Padding(
                      padding: inSetCell,
                      child: _buildResultRow('Pr(C|~B) = ', prCgivenNotB))),
            ]),
            TableRow(children: [
              TableCell(
                  child: Padding(
            ...
            TableRow(children: [
              TableCell(
                  child: Padding(
                      padding: inSetCell,
                      child: _buildResultRow('Pr(C&~(A&B)) = ', prCNotAandB))),
              TableCell(
                  child: Padding(
                      padding: inSetCell,
                      child: _buildResultRow('Pr(~(A&B)) = ', prNotAandB))),
            ]),
            TableRow(children: [
              TableCell(
                  child: Padding(
              ...
              TableCell(
                  child: Padding(
                      ...
                      child: _buildResultRowStr(
                          'Pr(C|A) >= Pr(C|B)',
                          (gt(sub(div(prAC, prA), div(prBC, prB)), (0, 1))
                              ? 'True'
                              : 'False'),
                          sizeFirst: 180))),
              TableCell(
              ...
              TableCell(
                  child: Padding(
                      ...
                      child: _buildResultRowStr('i(C,A) >= i(C,B)',
                          (gt(sub(iCA, iCB), (0, 1)) ? 'True' : 'False')))),
              TableCell(
                  child: Padding(
                      padding: inSetCell,
                      child: _buildResultRow('s(C, A&B) = ', sCAB))),
            ]),
            TableRow(children: [
              TableCell(
                  child: Padding(
                      padding: inSetCell,
                      child: _buildResultRow('s(C, A|B) = ', sCAgivenB))),
              TableCell(
                  child: Padding(
                      padding: inSetCell,
                      child: _buildResultRow('s(C, B|A) = ', sCBgivenA))),
            ]),
            TableRow(children: [
              TableCell(
                  child: Padding(
